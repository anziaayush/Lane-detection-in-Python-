...
### Data  
- Calibration images: stored in the `camera_cal/` directory.  
- Test images: stored in the `test_images/` directory for pipeline testing on single frames.  
- Videos:  
  - `project_video.mp4` – Main test video.  
  - `challenge_video.mp4` – Optional, moderate difficulty.  
  - `harder_challenge.mp4` – Optional, much harder test.
